                ...
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <h1 class="text-center login-title">Modificar Profesor</h1>
                        <div class="account-wall">
                                <br>
                                <form name="formulario" class="form-signin" action="ModificarProfesorServlet" method="post">
                                    ...
                                    <input type="text" class="form-control" value="<%=nombre%>" placeholder="Nombre" name="nombre" id="nombre" required>
                                     ...
                                     <br>
                                     <input type="text" class="form-control" value="<%=cedula%>" placeholder="Identificación" name="id" id="cedula" disabled required>
                                     <br>  
